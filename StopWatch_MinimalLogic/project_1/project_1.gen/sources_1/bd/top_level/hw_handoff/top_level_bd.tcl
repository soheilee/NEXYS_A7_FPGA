...
# module references:
# button, button, sevenseg_driver, stop_watch
...
proc create_hier_cell_source_100mhz { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst CPI_RESETN
  ...
  connect_bd_net -net ext_reset_in_0_1 [get_bd_pins CPI_RESETN] [get_bd_pins proc_sys_reset_0/ext_reset_in]
...
proc create_root_design { parentCell } {
  ...
  set NEWSTART [ create_bd_port -dir I NEWSTART ]
  ...
  # Create instance: button_1, and set properties
  set block_name button
  set block_cell_name button_1
  if { [catch {set button_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $button_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create port connections
  connect_bd_net -net PIN_0_1 [get_bd_ports STARTSTOP] [get_bd_pins button_0/PIN]
  connect_bd_net -net PIN_0_2 [get_bd_ports NEWSTART] [get_bd_pins button_1/PIN]
  connect_bd_net -net button_0_Q [get_bd_pins button_0/Q] [get_bd_pins stop_watch_0/startstop]
  connect_bd_net -net button_1_Q [get_bd_pins button_1/Q] [get_bd_pins stop_watch_0/newstart_stopwatch]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports CLK100MHZ] [get_bd_pins source_100mhz/CLK100MHZ]
  connect_bd_net -net clk_wiz_0_clk_100mhz [get_bd_pins button_0/CLK] [get_bd_pins button_1/CLK] [get_bd_pins sevenseg_driver_0/clk] [get_bd_pins source_100mhz/clk_100mhz] [get_bd_pins stop_watch_0/clk]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports CPU_RESETN] [get_bd_pins source_100mhz/CPI_RESETN]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins sevenseg_driver_0/resetn] [get_bd_pins source_100mhz/peripheral_aresetn]
