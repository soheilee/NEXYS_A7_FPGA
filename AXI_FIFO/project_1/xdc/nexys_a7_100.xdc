...
##Switchess
#set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {GPIO_SW_tri_i[0]}]
#set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {GPIO_SW_tri_i[1]}]
#set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {GPIO_SW_tri_i[2]}]
#set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {GPIO_SW_tri_i[3]}]
...
#set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {led_3}]
