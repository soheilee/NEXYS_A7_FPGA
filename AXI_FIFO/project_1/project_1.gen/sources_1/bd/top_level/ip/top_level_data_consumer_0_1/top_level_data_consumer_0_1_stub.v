...
module top_level_data_consumer_0_1(clk, resetn, axis_rx_tdata, axis_rx_tkeep, 
  axis_rx_tlast, axis_rx_tvalid, axis_rx_tready, packet_size)
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,axis_rx_tdata[127:0],axis_rx_tkeep[15:0],axis_rx_tlast,axis_rx_tvalid,axis_rx_tready,packet_size[15:0]" */;
  input clk;
  input resetn;
