...
module top_level_data_consumer_0_0(clk, AXIS_RX_TDATA, AXIS_RX_TKEEP, 
  AXIS_RX_TLAST, AXIS_RX_TVALID, AXIS_RX_TREADY, AXIS_RX2_TDATA, AXIS_RX2_TKEEP, 
  AXIS_RX2_TLAST, AXIS_RX2_TVALID, AXIS_RX2_TREADY, packet_count, packet_size)
/* synthesis syn_black_box black_box_pad_pin="clk,AXIS_RX_TDATA[511:0],AXIS_RX_TKEEP[63:0],AXIS_RX_TLAST,AXIS_RX_TVALID,AXIS_RX_TREADY,AXIS_RX2_TDATA[511:0],AXIS_RX2_TKEEP[63:0],AXIS_RX2_TLAST,AXIS_RX2_TVALID,AXIS_RX2_TREADY,packet_count[15:0],packet_size[15:0]" */;
  input clk;
  ...
  input [511:0]AXIS_RX2_TDATA;
  input [63:0]AXIS_RX2_TKEEP;
