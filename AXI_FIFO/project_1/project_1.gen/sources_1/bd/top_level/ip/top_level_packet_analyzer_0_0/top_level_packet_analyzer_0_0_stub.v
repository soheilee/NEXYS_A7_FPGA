...
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,packet_size[15:0],axis_in_tdata[127:0],axis_in_tkeep[15:0],axis_in_tlast,axis_in_tvalid,axis_in_tready,axis_packetsize_tdata[15:0],axis_packetsize_tvalid,axis_packetsize_tready,axis_packetbody_tdata[127:0],axis_packetbody_tkeep[15:0],axis_packetbody_tlast,axis_packetbody_tvalid,axis_packetbody_tready" */;
  input clk;
  input resetn;
  ...
  output [127:0]axis_packetbody_tdata;
  output [15:0]axis_packetbody_tkeep;
