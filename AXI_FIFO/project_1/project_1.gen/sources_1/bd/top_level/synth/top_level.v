...
module top_level
  ...
  top_level_system_ila_0_1 system_ila_0
       (.SLOT_0_AXIS_tdata(axis_data_fifo_0_M_AXIS1_TDATA),
        .SLOT_0_AXIS_tkeep(axis_data_fifo_0_M_AXIS1_TKEEP),
        .SLOT_0_AXIS_tlast(axis_data_fifo_0_M_AXIS1_TLAST),
        .SLOT_0_AXIS_tready(axis_data_fifo_0_M_AXIS1_TREADY),
        .SLOT_0_AXIS_tvalid(axis_data_fifo_0_M_AXIS1_TVALID),
        ...
        .clk(clk_wiz_0_clk_100mhz),
        .probe0(button_0_Q),
        .probe1(packet_counter_0_packet_count),
        .probe2(packet_counter_0_packet_size),
        .resetn(1'b1));
endmodule
