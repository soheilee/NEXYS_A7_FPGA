...
proc create_root_design { parentCell } {
  ...
  set probe1 [ create_bd_port -dir I -from 7 -to 0 probe1 ]
  set probe2 [ create_bd_port -dir I -from 3 -to 0 probe2 ]
  set probe3 [ create_bd_port -dir I -from 7 -to 0 probe3 ]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXIS] [get_bd_intf_pins g_inst/slot_0_axis]
  ...
  connect_bd_net -net net_slot_0_axis_tdata [get_bd_pins g_inst/m_slot_0_axis_tdata] [get_bd_pins ila_lib/probe5]
  connect_bd_net -net net_slot_0_axis_tkeep [get_bd_pins g_inst/m_slot_0_axis_tkeep] [get_bd_pins ila_lib/probe6]
