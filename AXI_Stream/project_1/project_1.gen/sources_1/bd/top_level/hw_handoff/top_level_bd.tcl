...
# module references:
# axi_stream_master, button, packet_counter, sevenseg_driver
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_stream_master_0, and set properties
  set block_name axi_stream_master
  set block_cell_name axi_stream_master_0
  if { [catch {set axi_stream_master_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_stream_master_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_stream_master_0_axisout [get_bd_intf_pins axi_stream_master_0/axisout] [get_bd_intf_pins packet_counter_0/axisin]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_stream_master_0_axisout] [get_bd_intf_pins packet_counter_0/axisin] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net PIN_0_1 [get_bd_ports START] [get_bd_pins button_0/PIN]
  connect_bd_net -net axi_stream_master_0_beat [get_bd_pins axi_stream_master_0/beat] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net button_0_Q [get_bd_pins axi_stream_master_0/start] [get_bd_pins button_0/Q]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports CLK100MHZ] [get_bd_pins source_100mhz/CLK100MHZ]
  connect_bd_net -net clk_wiz_0_clk_100mhz [get_bd_pins axi_stream_master_0/clk] [get_bd_pins button_0/CLK] [get_bd_pins packet_counter_0/clk] [get_bd_pins sevenseg_driver_0/clk] [get_bd_pins source_100mhz/clk_100mhz] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports CPU_RESETN] [get_bd_pins source_100mhz/CPU_RESETN]
  connect_bd_net -net packet_counter_0_count_keep [get_bd_pins packet_counter_0/count_keep] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net packet_counter_0_cyclecounter_output [get_bd_pins packet_counter_0/cyclecounter_output] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net packet_counter_0_digital_enable [get_bd_pins packet_counter_0/digital_enable] [get_bd_pins sevenseg_driver_0/digit_enable]
  connect_bd_net -net packet_counter_0_packetcounter_output [get_bd_pins packet_counter_0/packetcounter_output] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net packet_counter_0_sevenseg [get_bd_pins packet_counter_0/sevenseg] [get_bd_pins sevenseg_driver_0/display] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net packet_size_0_1 [get_bd_ports SWITCHES] [get_bd_pins axi_stream_master_0/beats_per_packet]
  ...
  connect_bd_net -net source_100mhz_peripheral_aresetn [get_bd_pins axi_stream_master_0/resentn] [get_bd_pins packet_counter_0/resentn] [get_bd_pins sevenseg_driver_0/resetn] [get_bd_pins source_100mhz/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins sevenseg_driver_0/dp_bitmap] [get_bd_pins xlconstant_0/dout]
