...
proc create_root_design { parentCell } {
  ...
  # Create instance: packet_analyzer_0, and set properties
  set block_name packet_analyzer
  set block_cell_name packet_analyzer_0
  if { [catch {set packet_analyzer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $packet_analyzer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net packet_analyzer_0_axis_out [get_bd_intf_pins packet_analyzer_0/axis_in] [get_bd_intf_pins packet_gen/axis_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets packet_analyzer_0_axis_out] [get_bd_intf_pins packet_analyzer_0/axis_in] [get_bd_intf_pins system_ila/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net packet_analyzer_0_axis_out1 [get_bd_intf_pins data_consumer/axis_rx] [get_bd_intf_pins packet_analyzer_0/axis_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets packet_analyzer_0_axis_out1] [get_bd_intf_pins packet_analyzer_0/axis_out] [get_bd_intf_pins system_ila/SLOT_1_AXIS]
  ...
  connect_bd_net -net clk_wiz_clk_100mhz [get_bd_pins button/CLK] [get_bd_pins data_consumer/clk] [get_bd_pins packet_analyzer_0/clk] [get_bd_pins packet_gen/clk] [get_bd_pins source_100mhz/clk_100mhz] [get_bd_pins system_ila/clk]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports CPU_RESETN] [get_bd_pins source_100mhz/CPU_RESETN]
  connect_bd_net -net source_100mhz_peripheral_aresetn [get_bd_pins data_consumer/resetn] [get_bd_pins packet_analyzer_0/resetn] [get_bd_pins packet_gen/resetn] [get_bd_pins source_100mhz/peripheral_aresetn]
