...
# module references:
# analyzer_module, button, data_consumer, packet_gen
...
proc create_root_design { parentCell } {
  ...
  # Create instance: analyzer_module, and set properties
  set block_name analyzer_module
  set block_cell_name analyzer_module
  if { [catch {set analyzer_module [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $analyzer_module eq "" } {
  ...
  connect_bd_intf_net -intf_net packet_analyzer_0_axis_out [get_bd_intf_pins analyzer_module/axis_in] [get_bd_intf_pins packet_gen/axis_out]
connect_bd_intf_net -intf_net [get_bd_intf_nets packet_analyzer_0_axis_out] [get_bd_intf_pins analyzer_module/axis_in] [get_bd_intf_pins system_ila/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net packet_analyzer_0_axis_out1 [get_bd_intf_pins analyzer_module/axis_out] [get_bd_intf_pins data_consumer/axis_rx]
connect_bd_intf_net -intf_net [get_bd_intf_nets packet_analyzer_0_axis_out1] [get_bd_intf_pins analyzer_module/axis_out] [get_bd_intf_pins system_ila/SLOT_1_AXIS]

  # Create port connections
  connect_bd_net -net PIN_0_1 [get_bd_ports BTNU] [get_bd_pins button/PIN]
  connect_bd_net -net button_0_Q [get_bd_pins button/Q] [get_bd_pins packet_gen/start]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports CLK100MHZ] [get_bd_pins source_100mhz/CLK100MHZ]
  connect_bd_net -net clk_wiz_clk_100mhz [get_bd_pins analyzer_module/clk] [get_bd_pins button/CLK] [get_bd_pins data_consumer/clk] [get_bd_pins packet_gen/clk] [get_bd_pins source_100mhz/clk_100mhz] [get_bd_pins system_ila/clk]
  connect_bd_net -net ext_reset_in_0_1 [get_bd_ports CPU_RESETN] [get_bd_pins source_100mhz/CPU_RESETN]
  connect_bd_net -net source_100mhz_peripheral_aresetn [get_bd_pins analyzer_module/resetn] [get_bd_pins data_consumer/resetn] [get_bd_pins packet_gen/resetn] [get_bd_pins source_100mhz/peripheral_aresetn]
